...
use super::{
    super::{
        super::{Engine, flow_wallet_signed_amount, parse_vault_uuid},
        helpers::{
            ...
            Box::pin(async move {
                ...
                match kind {
                    ...
                    | TransactionKind::Refund => {
                        ...
                        engine
                            .require_wallet_in_vault(db_tx, vault_id, new_wallet_id)
                            .await?;
                        engine
                            .require_flow_in_vault(db_tx, vault_id, new_flow_id)
                            .await?;
